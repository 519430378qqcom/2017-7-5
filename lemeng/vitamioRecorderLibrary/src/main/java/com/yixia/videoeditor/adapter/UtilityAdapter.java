...
public class UtilityAdapter {
     ...
     * )
     *
     * @param strtag 任务的唯一标识，如果标识为""，以阻塞方式运行，否则以异步方式运行
     * @param strcmd 命令行
     * @return 返回执行结果
     */
    ...
    public static boolean ndkAudioInit() {
        ...
        if (mAudioTrack == null) {
            ...
            // Instantiating AudioTrack can "succeed" without an exception and the com.lvshandian.haiyan.moudles.index.live.track may still be invalid
