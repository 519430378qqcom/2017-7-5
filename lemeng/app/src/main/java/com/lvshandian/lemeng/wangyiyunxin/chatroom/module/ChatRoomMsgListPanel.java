...
//        items.add(MessageBuilder.createTextMessage(container.account, container.sessionType, "我们提倡绿色直播"));
...
//        messageListView.setOnRefreshListener(new MessageLoader());
    ...
    public void clickMessageItem(final ItemClickListener listener) {
        messageListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                LogUtils.i("WangYi", "点击OnItem\nSessionId:" + items.get(i).getSessionId());
//                listener.onClickItem(adapterView, view, items.get(i), l);
            }
        });
    }
    ...
    public void onIncomingMessage(List<ChatRoomMessage> messages) {
        ...
        if (addedListItems != null && addedListItems.size() > 0) {
            for (int i = 0, j = addedListItems.size(); i < j; i++) {
                ...
                if (newMessage != null && remote != null && !TextUtils.isEmpty((String) remote.get("type")) && (remote.get("type").equals("109") || (remote.get("type")).equals("106") || remote.get("type").equals("107") || remote.get("type").equals("108") || remote.get("type").equals("105") || remote.get("type").equals("101") || remote.get("type").equals("103") || remote.get("type").equals("104") || remote.get("type").equals("202") || (remote.get("type")).equals("110") || (remote.get("type")).equals("111") || (remote.get("type")).equals("114") || (remote.get("type")).equals("112") || (remote.get("type")).equals("113") || (remote.get("type")).equals("199") || (remote.get("type")).equals("2828") || (remote.get("type")).equals("1818") || (remote.get("type")).equals("10009") || (remote.get("type")).equals("2929")|| (remote.get("type")).equals("3030"))) {
                    //收到 109 礼物消息 发送广播
    ...
    public void onMsgSend(IMMessage message) {
        ...
        if (message instanceof ChatRoomMessage && addedListItems != null && addedListItems.size() > 0) {
            ...
            if (newMessage != null && remote != null && !TextUtils.isEmpty((String) remote.get("type")) && ((remote.get("type")).equals("109") || (remote.get("type")).equals("106") || (remote.get("type")).equals("107") || (remote.get("type")).equals("108") || (remote.get("type")).equals("105") || (remote.get("type")).equals("114") || (remote.get("type")).equals("112") || (remote.get("type")).equals("113") || (remote.get("type")).equals("199") || (remote.get("type")).equals("2828") || (remote.get("type")).equals("1818") || (remote.get("type")).equals("10009")|| (remote.get("type")).equals("5858"))) {
                //收到 109 礼物消息 发送广播
                LogUtil.i("WangYi_gift", "发礼物广播");
                container.activity.sendBroadcast(new Intent().setAction("WatchLiveActivity").putExtra("ChatRoomMessage", newMessage));
            } else if (newMessage != null && remote != null && !TextUtils.isEmpty((String) remote.get("danmu")) && remote.get("danmu").equals("true")) {
     ...
     *
     * @author sll
     * @time 2016/11/18 19:55
     */
    public void addHeadView(LayoutInflater inflater) {
        View headerView = inflater.inflate(R.layout.watch_live_message_head, null);
    ...
    private class MsgItemEventListener implements MsgAdapter.ViewHolderEventListener {
        ...
        public boolean onViewHolderLongClick(View clickView, View viewHolderView, IMMessage item) {
            LogUtils.i("WangYi", "点击OnItem\nonViewHolderLongClick" + item.getSessionId());
            return true;
        }
