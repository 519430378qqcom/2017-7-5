package com.lvshandian.lemeng.third.wangyiyunxin.session;
...
import com.lvshandian.lemeng.third.wangyiyunxin.session.action.FileAction;
import com.lvshandian.lemeng.third.wangyiyunxin.session.action.GuessAction;
import com.lvshandian.lemeng.third.wangyiyunxin.session.action.RTSAction;
import com.lvshandian.lemeng.third.wangyiyunxin.session.action.SnapChatAction;
import com.lvshandian.lemeng.third.wangyiyunxin.session.action.TipAction;
import com.lvshandian.lemeng.third.wangyiyunxin.session.activity.MessageHistoryActivity;
import com.lvshandian.lemeng.third.wangyiyunxin.session.activity.MessageInfoActivity;
import com.lvshandian.lemeng.third.wangyiyunxin.session.extension.CustomAttachParser;
import com.lvshandian.lemeng.third.wangyiyunxin.session.extension.CustomAttachment;
import com.lvshandian.lemeng.third.wangyiyunxin.session.extension.GuessAttachment;
import com.lvshandian.lemeng.third.wangyiyunxin.session.extension.RTSAttachment;
import com.lvshandian.lemeng.third.wangyiyunxin.session.extension.SnapChatAttachment;
import com.lvshandian.lemeng.third.wangyiyunxin.session.extension.StickerAttachment;
import com.lvshandian.lemeng.third.wangyiyunxin.session.search.SearchMessageActivity;
import com.lvshandian.lemeng.third.wangyiyunxin.session.viewholder.MsgViewHolderAVChat;
import com.lvshandian.lemeng.third.wangyiyunxin.session.viewholder.MsgViewHolderDefCustom;
import com.lvshandian.lemeng.third.wangyiyunxin.session.viewholder.MsgViewHolderFile;
import com.lvshandian.lemeng.third.wangyiyunxin.session.viewholder.MsgViewHolderGuess;
import com.lvshandian.lemeng.third.wangyiyunxin.session.viewholder.MsgViewHolderRTS;
import com.lvshandian.lemeng.third.wangyiyunxin.session.viewholder.MsgViewHolderSnapChat;
import com.lvshandian.lemeng.third.wangyiyunxin.session.viewholder.MsgViewHolderSticker;
import com.lvshandian.lemeng.third.wangyiyunxin.session.viewholder.MsgViewHolderTip;
...
//                    AppUser appUser = (AppUser) CacheUtils.readObject(context, CacheUtils.USERINFO);
                    ...
                    if (team != null && team.isMyTeam()) {
                        NimUIKit.startTeamInfo(context, sessionId, appUser.getId());
                    } else {
    ...
    private static void setSessionListener() {
        SessionEventListener listener = new SessionEventListener() {
            ...
            public void onAvatarClicked(Context context, IMMessage message) {
                // 一般用于打开用户资料页面
                OtherPersonHomePageActivity.start(context, message.getFromAccount().substring(4,message.getFromAccount().length()));
            }
