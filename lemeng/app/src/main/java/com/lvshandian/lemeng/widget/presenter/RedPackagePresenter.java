package com.lvshandian.lemeng.widget.presenter;
 ...
 * desc   : 红包功能的presenter
 */
public class RedPackagePresenter implements IRedPackageContract.Presenter{
    private IRedPackageContract.IView iView;

    public RedPackagePresenter(IRedPackageContract.IView iView) {
        this.iView = iView;
    }
