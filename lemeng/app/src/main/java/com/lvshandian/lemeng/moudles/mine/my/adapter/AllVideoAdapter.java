...
public class AllVideoAdapter extends BaseAdapter {
    ...
    public AllVideoAdapter(Context mContext, List<VideoBean> list) {
         this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        VideoBean photoBean = list.get(position);
        viewHolder.video_start.setVisibility(View.VISIBLE);
        ImageLoader.getInstance().displayImage(photoBean.getThumbnailUrl(),viewHolder.img_gridview);
        return convertView;
    }
