package com.lvshandian.lemeng.third.wangyiyunxin.main.activity;
...
import com.lvshandian.lemeng.third.wangyiyunxin.main.adapter.SystemMessageAdapter;
import com.lvshandian.lemeng.third.wangyiyunxin.main.viewholder.SystemMessageViewHolder;
 ...
 */
public class WYYXSystemMessageActivity extends UI implements TAdapterDelegate,
    ...
    public static void start(Context context, Intent extras, boolean clearTop) {
        ...
        intent.setClass(context, WYYXSystemMessageActivity.class);
...
//        options.titleId = R.string.verify_reminder;
        ...
        title = (TextView) findViewById(R.id.system_message_title);
        title.setText("消息提醒");
        setTitle("");
    ...
    private void onIncomingMessage(final SystemMessage message) {
        LogUtils.e("messagegetContent", "message" + message.getContent());
        // 同一个账号的好友申请仅保留最近一条
    ...
    private void onProcessFailed(final int code, SystemMessage message) {
        Toast.makeText(WYYXSystemMessageActivity.this, "failed, error code=" + code,
    ...
    Observer<SystemMessage> systemMessageObserver = new Observer<SystemMessage>() {
        ...
        public void onEvent(SystemMessage systemMessage) {
            LogUtils.e("messagegetContent", "message" + systemMessage.getContent());
    ...
    private void deleteAllMessages() {
        ...
        items.clear();
        refresh();
        Toast.makeText(WYYXSystemMessageActivity.this, R.string.clear_all_success, Toast.LENGTH_SHORT).show();
    }
    ...
    private void deleteSystemMessage(final SystemMessage message) {
        ...
        refresh();
        ToastUtils.showMessageDefault(WYYXSystemMessageActivity.this, getResources().getString(R.string.delete_success));
    }
}
