 ...
 */
public class ChatRoomViewHolderShowMsg extends MsgViewHolderBase {
    @Override
...
//        bodyTextView.setTextColor(context.getResources().getColor(R.color.tv_main));
        ...
        String bodyText = (String) data.get("text");
        MoonUtil.identifyFaceExpression(NimUIKit.getContext(), bodyTextView, null,bodyText, ImageSpan.ALIGN_BOTTOM);
    }
