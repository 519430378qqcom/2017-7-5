...
import static com.lvshandian.lemeng.R.id.seconds;
...
public class LWheelDialog extends Dialog implements LWheelView.LWheelViewListener,View.OnClickListener {
	...
	public LWheelDialog(Context context, LWheelDialogType type) {
		super(context);
		this.type = type;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		wheel6 = (LWheelView) findViewById(seconds);
	...
	public void setLWheelViewListener( LWheelView.LWheelViewListener listener){
		this.listener = listener;
	}
	private ConfirmListener confirmListener;
	public interface ConfirmListener{
		void onConfirmListener(String year, String month, String day);
	}
	...
	public void onClick(View v) {
		...
		case R.id.wheel_enter:
			if(confirmListener != null) {
			    confirmListener.onConfirmListener(year,month,day);
			}
			switch (type) {
			case ALL:
				break;
