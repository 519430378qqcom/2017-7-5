...
/**
 * Created by pjz on 2015-04-30.from rongyun2 demo
 */
public class DateUtils {
     ...
     * @return 转换后的时间格式
     */
    public static String getStringToday(Date createdDate, String dateFormat) {
     ...
     * @return 转换后的时间格式
     */
    public static String getStringToday(long mills,String dateFormat) {
    ...
    public static String millisToDateString(Long mills,String dateFormat){
        if (mills==null){
            return "";
        }
        SimpleDateFormat formatter = new SimpleDateFormat(dateFormat);
