...
public class AnchorVideoOne {
    ...
    private class UIHandler extends Handler {
        ...
        StartLiveActivity mActivity;

        public UIHandler(StartLiveActivity activty) {
            mActivity = activty;
        }
    ...
    //初始化播放器
    public void initLive(String mVideoPath, Activity mContext, SurfaceView mSurfaceView) {
        this.mContext = mContext;
        this.mSurfaceView = mSurfaceView;
        this.mVideoPath = mVideoPath;
        mHandler = new UIHandler((StartLiveActivity) mContext);
        try {
