package com.lvshandian.lemeng.moudles.group.adapter;
...
import com.netease.nim.uikit.team.activity.CircleImageView;
...
public class FunseListForGroupAdapter extends CommonAdapter<FunseBean> {
    ...
    public void convert(ViewHolder helper, FunseBean item, final int position) {
        ...
        CircleImageView ivHeader = helper.getView(R.id.uikit_userHead);
