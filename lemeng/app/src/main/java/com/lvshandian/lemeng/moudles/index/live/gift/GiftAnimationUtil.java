package com.lvshandian.lemeng.moudles.index.live.gift;
...
// animSet.playSequentially(animators);
    ...
    /**
     * @param animator1
     * @return 按顺序播放动画，礼物背景不消失
     */
    public static AnimatorSet startAnimationing(ObjectAnimator animator1, ObjectAnimator animator2) {
        AnimatorSet animSet = new AnimatorSet();
// animSet.playSequentially(animators);
        animSet.play(animator1).before(animator2);
        animSet.start();
    ...
    /**
     * @param animator
     * @return 播放连送数字动画，礼物背景不消失
     */
    public static AnimatorSet startAnimationTex(ObjectAnimator animator) {
        AnimatorSet animSet = new AnimatorSet();
     ...
     * @return 播放礼物背景消失动画
     */
    public static AnimatorSet startAnimationHint(ObjectAnimator animator) {
        AnimatorSet animSet = new AnimatorSet();
        animSet.play(animator);
        animSet.start();
        return animSet;
