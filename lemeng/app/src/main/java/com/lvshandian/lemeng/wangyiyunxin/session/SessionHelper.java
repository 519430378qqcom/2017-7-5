package com.lvshandian.lemeng.wangyiyunxin.session;
...
import com.lvshandian.lemeng.wangyiyunxin.session.action.RTSAction;
import com.lvshandian.lemeng.wangyiyunxin.session.action.SnapChatAction;
import com.lvshandian.lemeng.wangyiyunxin.session.action.TipAction;
import com.lvshandian.lemeng.wangyiyunxin.session.activity.MessageHistoryActivity;
import com.lvshandian.lemeng.wangyiyunxin.session.activity.MessageInfoActivity;
import com.lvshandian.lemeng.wangyiyunxin.session.extension.CustomAttachParser;
import com.lvshandian.lemeng.wangyiyunxin.session.extension.CustomAttachment;
import com.lvshandian.lemeng.wangyiyunxin.session.extension.GuessAttachment;
import com.lvshandian.lemeng.wangyiyunxin.session.extension.RTSAttachment;
import com.lvshandian.lemeng.wangyiyunxin.session.extension.SnapChatAttachment;
import com.lvshandian.lemeng.wangyiyunxin.session.extension.StickerAttachment;
import com.lvshandian.lemeng.wangyiyunxin.session.search.SearchMessageActivity;
import com.lvshandian.lemeng.wangyiyunxin.session.viewholder.MsgViewHolderAVChat;
import com.lvshandian.lemeng.wangyiyunxin.session.viewholder.MsgViewHolderDefCustom;
import com.lvshandian.lemeng.wangyiyunxin.session.viewholder.MsgViewHolderFile;
import com.lvshandian.lemeng.wangyiyunxin.session.viewholder.MsgViewHolderGuess;
import com.lvshandian.lemeng.wangyiyunxin.session.viewholder.MsgViewHolderRTS;
import com.lvshandian.lemeng.wangyiyunxin.session.viewholder.MsgViewHolderSnapChat;
import com.lvshandian.lemeng.wangyiyunxin.session.viewholder.MsgViewHolderSticker;
import com.lvshandian.lemeng.wangyiyunxin.session.viewholder.MsgViewHolderTip;
