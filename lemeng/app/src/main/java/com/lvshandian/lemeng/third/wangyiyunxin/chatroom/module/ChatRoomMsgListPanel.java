package com.lvshandian.lemeng.third.wangyiyunxin.chatroom.module;
...
import com.lvshandian.lemeng.third.wangyiyunxin.chatroom.viewholder.ChatRoomMsgViewHolderFactory;
        ...
        if (addedListItems != null && addedListItems.size() > 0) {
            for (int i = 0, j = addedListItems.size(); i < j; i++) {
                ...
                if (newMessage != null && remote != null && !TextUtils.isEmpty((String) remote.get("type")) && (remote.get("type").equals("105") || remote.get("type").equals("106") || remote.get("type").equals("107") || remote.get("type").equals("108") || remote.get("type").equals("109")
                        ...
                        || remote.get("type").equals("1818") || remote.get("type").equals("2828") || remote.get("type").equals("2929") || remote.get("type").equals("3030") || remote.get("type").equals("10009") || "3131".equals(remote.get("type")) || "301".equals(remote.get("type"))|| "606".equals(remote.get("type"))
