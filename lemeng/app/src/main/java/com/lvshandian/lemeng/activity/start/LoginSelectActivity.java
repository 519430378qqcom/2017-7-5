...
import com.lvshandian.lemeng.activity.mine.ExplainWebViewActivity;
import com.lvshandian.lemeng.activity.mine.SettingHeadAndNick;
import com.lvshandian.lemeng.interfaces.CustomStringCallBackOne;
    ...
    private UMAuthListener umAuthListener = new UMAuthListener() {
        ...
        public void onComplete(SHARE_MEDIA platForm, int action, Map<String, String> map) {
            ...
            if (platForm == SHARE_MEDIA.WEIXIN) {
                ...
                params.put("unionId", map.get("uid").toString());
                params.put("password", map.get("accessToken").toString());
                params.put("userName", map.get("first_name").toString());
                params.put("nickName", map.get("name").toString());
                params.put("picUrl", map.get("iconurl") == null ? "" : map.get("iconurl").toString());
                params.put("gender", "1");
            }
            thirdLogin(params);
