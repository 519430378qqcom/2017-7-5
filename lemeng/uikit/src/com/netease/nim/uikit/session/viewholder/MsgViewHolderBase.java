...
public abstract class MsgViewHolderBase extends TViewHolder {
    ...
    protected void onItemClick() {
        LogUtil.i("WangYi", "onItemClick");
        LogUtil.i("WangYi", "FromAccount:" + message.getFromAccount());
        if (isChatRoom()) {
            //如果是聊天室，发广播，显示用户信息
            LogUtil.i("WangYi", "聊天室，发广播");
            context.sendBroadcast(new Intent().setAction("WatchLiveActivity").putExtra("FromAccount", message.getFromAccount()));
    ...
    protected final void inflate() {
        ...
        levelLeft = findViewById(R.id.message_item_portrait_new);
        ...
        messageItemLayout = findViewById(R.id.message_item_layout);
...
//                progressBar.setVisibility(View.VISIBLE);
    ...
    private void setHeadImageView() {
        ...
        if (isChatRoom()) {
            ...
            show = isReceivedMessage() ? avatarLeft : avatarRight;
            hide = isReceivedMessage() ? avatarRight : avatarLeft;
        }
