...
//        bodyTextView.setTextColor(Color.WHITE);
        ...
        MoonUtil.identifyFaceExpression(NimUIKit.getContext(), bodyTextView, null, getDisplayText(), ImageSpan.ALIGN_BOTTOM);
...
//        bodyTextView.setTextColor(Color.WHITE);
    ...
    protected String getDisplayTextForCustom() {
        if (message.getRemoteExtension() != null) {
            LogUtil.i("WangYi", "remoteExtension:" + message.getRemoteExtension());
        }
        return message.getContent();
    }
}
