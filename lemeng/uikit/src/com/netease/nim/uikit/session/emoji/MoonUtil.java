...
public class MoonUtil {
    ...
    public static void identifyFaceExpression(Context context,
                                              View textView, String name, String value, int align) {
        identifyFaceExpression(context, textView, name, value, align, DEF_SCALE);
    }
    ...
    /**
     * 具体类型的view设置内容
     * create by shangshuaibo
     *
     * @param textView
     * @param mSpannableString
     */
    private static void viewSetText(View textView, String name, SpannableString mSpannableString) {
        if (textView instanceof TextView) {
            TextView tv = (TextView) textView;
            if (name == null) {
                tv.setText(mSpannableString);
            } else {
                SpannableStringBuilder style = new SpannableStringBuilder(name + mSpannableString);
//                if (mSpannableString.toString().contains("关注了")){
...
//                }
    ...
    public static void identifyFaceExpression(Context context,
                                              View textView, String name, String value, int align, float scale) {
        SpannableString mSpannableString = replaceEmoticons(context, value, scale, align);
        viewSetText(textView, name, mSpannableString);
    }
