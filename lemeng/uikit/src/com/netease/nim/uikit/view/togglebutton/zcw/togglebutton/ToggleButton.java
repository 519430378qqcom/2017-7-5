package com.netease.nim.uikit.view.togglebutton.zcw.togglebutton;
...
import com.netease.nim.uikit.view.togglebutton.facebook.rebound.SimpleSpringListener;
import com.netease.nim.uikit.view.togglebutton.facebook.rebound.Spring;
import com.netease.nim.uikit.view.togglebutton.facebook.rebound.SpringConfig;
import com.netease.nim.uikit.view.togglebutton.facebook.rebound.SpringSystem;
import com.netease.nim.uikit.view.togglebutton.facebook.rebound.SpringUtil;
...
public class ToggleButton extends View {
     ...
     * 开启颜色
     */
    private int onColor = Color.parseColor("#F6D42C");
    /**
     * 关闭颜色
     */
    ...
    public void draw(Canvas canvas) {
        ...
        float textSize = spotR / 3 * 2;
        paint.setTextSize(textSize);
        canvas.drawText("弹幕", spotX - textSize, centerY + textSize / 2, paint);
    }
